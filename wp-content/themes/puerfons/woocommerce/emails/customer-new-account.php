...
<div style="color:#636363">
    <?php
printf( esc_html__( 'It is highly recommended to reset your own password for security reason.','woocommerce'));
echo '<br/><br/>';
printf( esc_html__( 'We look forward to seeing you soon.','woocommerce'));
?>
</div>
<?php
