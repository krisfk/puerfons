<div class="product-page" style="background-image: url('<?php echo get_template_directory_uri();?>/img/product-bg.png');">
	<div class="product-top">
		<div class="product-title-bg <?php $images = get_field('product_gallery'); if( $images ){ echo "have-gallery"; } else { echo "no-gallery"; }; ?>">
						...
						<ul>
							...
							if( have_rows('content_module') ):
							    ...
							    while ( have_rows('content_module') ) : the_row();
							    	...
							    	?><li class="<?php if($i == 1){ echo "active"; } ?>"><a href="#scroll<?php echo $i; $i++?>"><?php the_sub_field("title"); ?></a></li><?php
					...
					<?php
						...
						if( have_rows('content_module') ):
						    ...
						    while ( have_rows('content_module') ) : the_row();
						    	...
						    	?>
						    	<div id="scroll<?php echo $i; ?>" class="hidden-content-box <?php if($i == 1){ echo "active"; } $i++; ?>">
